...
const features = [
  {
    ...
    color: "linear-gradient(135deg, #8a2be2 0%, #6a1bb2 100%)",
  },
  {
    icon: Clock,
    title: "Do 24 hodín",
    ...
    color: "linear-gradient(135deg, #00f5ff 0%, #00c5cf 100%)",
  },
  {
    icon: Zap,
    ...
    color: "linear-gradient(135deg, #ff6b9d 0%, #ff4081 100%)",
  },
  {
    icon: Users,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="backdrop-blur-md border rounded-2xl p-5 shadow-lg transition-all"
              style={{
            ...
            >
              ...
              <p className="text-[10px] uppercase tracking-wider mb-2 font-bold" style={{ color: 'var(--secondary-neon)' }}>{feature.subtitle}</p>
