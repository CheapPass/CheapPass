        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed" style={{ color: 'var(--text-muted)' }}>
              Vaša najlepšia voľba pre herné predplatné za skvelé ceny. Bezpečne a rýchlo.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs" style={{ color: 'var(--text-muted)' }}>
              <li><a href="#" className="hover:text-[var(--secondary-neon)] transition-colors">Všetky passy</a></li>
              <li><a href="#" className="hover:text-[var(--secondary-neon)] transition-colors">Ako to funguje</a></li>
          ...
          {/* Podpora */}
          <div>
            <h4 className="text-sm font-bold mb-4 text-white">Podpora</h4>
            <ul className="space-y-2 text-xs" style={{ color: 'var(--text-muted)' }}>
              ...
              <li><a href="#" className="hover:text-[var(--secondary-neon)] transition-colors">Kontakt</a></li>
            </ul>
          </div>

          {/* Kontakt */}
          <div>
            <h4 className="text-sm font-bold mb-4 text-white">Kontakt</h4>
            <div className="space-y-3 text-xs" style={{ color: 'var(--text-muted)' }}>
              ...
              <div className="flex items-center gap-2">
                <Shield className="w-4 h-4 text-[var(--secondary-neon)]" />
